<div class="container py-8">
    ...
    <x-table-responsive>
        ...
        <div class="px-6 py-4 flex">
            <input class="form-input flex-1 shadow-sm" placeholder="Buscar curso..." wire:model="search" wire:keydown="clean_page">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    <div class="flex-shrink-0 h-10 w-10">
                                        ...
                                        @else
                                            <img class="h-10 w-10 rounded-full object-cover object-center" src="https://cdn.pixabay.com/photo/2017/04/19/13/15/computer-2242263_960_720.jpg" alt="">
                                        @endisset
                                    </div>
                                    <div class="ml-4">
        ...
        @else
            <div class="px-6 py-4">
                No existe nigun curso coincidente
            </div>
        @endif
